...
const AGENT_TYPE_CATALOG = {
  'general-purpose': {
    ...
    description: 'Generalist coding agent for multi-step implementation, debugging, and synthesis.',
    readOnly: false,
    allowWrite: true,
    allowShell: true,
    allowSpawn: true,
    orchestrationOnly: false,
    instruction: 'Act as the main execution agent. You may inspect, edit, run checks, and coordinate subagents when it improves the result.'
  },
  'Explore': {
    title: 'Explore',
    description: 'Fast read-only explorer focused on code search, structure, and factual answers.',
    readOnly: true,
    allowWrite: false,
    allowShell: false,
    allowSpawn: false,
    orchestrationOnly: false,
    instruction: 'Stay strictly read-only. Focus on discovery, code search, architecture mapping, and concise factual findings. Do not modify files.'
  },
  'Plan': {
    title: 'Plan',
    description: 'Read-only planning agent for architecture, sequencing, and tradeoffs.',
    readOnly: true,
    allowWrite: false,
    allowShell: false,
    allowSpawn: false,
    orchestrationOnly: false,
    instruction: 'Stay read-only. Produce implementation plans, risk analysis, and sequencing. Do not modify files or execute write tools.'
  },
  'verification': {
    title: 'Verification',
    description: 'Read-only verifier that validates behavior and produces a verdict.',
    readOnly: true,
    allowWrite: false,
    allowShell: true,
    allowSpawn: false,
    orchestrationOnly: false,
    instruction: 'Do not edit files. Verify claims, run tests when safe, look for regressions, and end with VERDICT: PASS, FAIL, or PARTIAL.'
  },
  'worker': {
    title: 'Worker',
    description: 'Execution agent for a bounded slice of work.',
    readOnly: false,
    allowWrite: true,
    allowShell: true,
    allowSpawn: false,
    orchestrationOnly: false,
    instruction: 'Own a narrow execution slice. Prefer concrete changes and validation over broad exploration. Do not orchestrate other agents unless explicitly instructed.'
  },
  'team-lead': {
    title: 'Team Lead',
    description: 'Coordinator agent that decomposes work across workers and a verifier.',
    readOnly: true,
    allowWrite: false,
    allowShell: false,
    allowSpawn: true,
    orchestrationOnly: true,
    instruction: 'Coordinate work. Delegate to workers, collect results, and request verification. Avoid direct file edits unless absolutely necessary.'
  },
  'fork': {
    title: 'Fork',
    description: 'Forked agent that inherits context from another agent or conversation branch.',
    readOnly: false,
    allowWrite: true,
    allowShell: true,
    allowSpawn: true,
    orchestrationOnly: false,
    instruction: 'You are a fork of an existing agent context. Preserve continuity with the parent branch while pursuing the new objective.'
  },
  'guide': {
    title: 'Guide',
    description: 'Instructional agent for architecture and usage guidance.',
    readOnly: true,
    allowWrite: false,
    allowShell: false,
    allowSpawn: false,
    orchestrationOnly: false,
    instruction: 'Focus on documentation, guidance, and explanation. Prefer references, examples, and operational advice over implementation.'
  }
};

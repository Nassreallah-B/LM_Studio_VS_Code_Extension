...
(async () => {
  try {
    ...
    results.fail++;
    results.errors.push(`Swarm Execution Error: ${err.message}`);
  ...
  try {
    ...
    results.fail++;
    results.errors.push(`CVE Scanner Error: ${err.message}`);
    console.error('  ❌ CVE Scanner Error:', err);
  }
  ...
  try {
    ...
    results.fail++;
    results.errors.push(`Encryption Error: ${err.message}`);
  ...
  try {
    ...
    results.fail++;
    results.errors.push(`Hooks & Workers Error: ${err.message}`);
    console.error('  ❌ Hooks & Workers Error:', err);
  }
